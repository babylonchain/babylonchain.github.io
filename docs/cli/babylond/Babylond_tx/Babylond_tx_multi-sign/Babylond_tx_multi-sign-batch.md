...
sidebar_label: babylond tx multi-sign batch
hide_table_of_contents: true

---

# babylond tx multi-sign batch
Assemble mutisig signatures in batch from batch signatures.
## tx multi-sign command batch
```
