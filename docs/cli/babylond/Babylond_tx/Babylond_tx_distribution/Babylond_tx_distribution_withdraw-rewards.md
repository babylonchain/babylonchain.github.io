...
```
babylond tx distribution withdraw-rewards [validator-addr] [flags]
```
### Example Command
```
$ babylond tx distribution withdraw-rewards babylonddev1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj --from mykey --yes
```
## Options
```
