...
```
babylond tx distribution set-withdraw-addr [withdraw-addr] [flags]
```
### Example Command
```
$ babylond tx distribution set-withdraw-addr babylond1gghjut3ccd8ay0zduzj64hwre2fxs9ld88ioP5 --yes
```
## Options
```
