...
```
babylond tx ibc client misbehaviour [path/to/misbehaviour.json] [flags]

```
### Example Command
```
$ babylond tx ibc client misbehaviour [path/to/misbehaviour.json] --from node0 --home ../node0/<app>cli --chain-id $CID
```
## Options
```
