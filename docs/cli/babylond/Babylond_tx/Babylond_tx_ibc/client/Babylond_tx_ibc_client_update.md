...
```
babylond tx ibc client update [client-id] [path/to/header.json] [flags]

```
### Example Command
```
$ babylond tx ibc client update [client-id] [path/to/header.json] --from node0 --home ../node0/<app>cli --chain-id $CID
```
## Options
```
